...
class LoanRiskModel:
    ...
    def preprocess_data(self, X):
        ...
        if 'is_collateralized' in X_processed.columns:
            X_processed['is_collateralized'] = X_processed['is_collateralized'].astype(int)
        
        # Calculate collateral ratio
        X_processed['collateral_value_to_loan_ratio'] = X_processed['collateral_value'] / X_processed['loan_amount']
        X_processed['collateral_value_to_loan_ratio'] = X_processed['collateral_value_to_loan_ratio'].fillna(0)
    ...
    def predict_risk_score(self, loan_data):
        ...
        for feature in self.features:
            ...
            elif feature == 'collateral_value_to_loan_ratio' and 'collateral_value' in loan_data.columns and 'loan_amount' in loan_data.columns:
                prediction_data[feature] = loan_data['collateral_value'] / loan_data['loan_amount']
        ...
        if 'is_collateralized' in prediction_data.columns:
            prediction_data['is_collateralized'] = prediction_data['is_collateralized'].astype(int)
    ...
    def generate_synthetic_training_data(self, n_samples=1000):
        ...
        X.loc[mask, 'collateral_value'] = X.loc[mask, 'loan_amount'] * np.random.uniform(1, 2, mask.sum())
