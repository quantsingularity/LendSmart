...
class BlockchainService {
    constructor() {
        ...
        this.networks = {
            ...
            sepolia: {
                ...
                chainId: 11155111,
                rpcUrl:
                    process.env.SEPOLIA_RPC_URL || 'https://sepolia.infura.io/v3/YOUR_PROJECT_ID',
    ...
    async deployContract(networkName, contractData, constructorArgs = []) {
        try {
            ...
            throw new AppError('Contract deployment failed', 500, 'DEPLOYMENT_ERROR', {
    ...
    async listenToEvents(networkName, contractAddress, abi, eventName, callback, filter = {}) {
        try {
            ...
            throw new AppError('Failed to set up event listener', 500, 'EVENT_LISTENER_ERROR', {
                originalError: error.message,
            });
        }
    }
