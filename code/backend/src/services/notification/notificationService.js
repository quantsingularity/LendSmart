...
class NotificationService {
    ...
    async sendEmail(emailData) {
        try {
            ...
            throw new AppError('Failed to send email notification', 500, 'EMAIL_SEND_ERROR', {
    ...
    async sendSMS(smsData) {
        try {
            ...
            throw new AppError('Failed to send SMS notification', 500, 'SMS_SEND_ERROR', {
                originalError: error.message,
                to: smsData.to,
            });
        }
    ...
    async sendPushNotification(pushData) {
        try {
            ...
            throw new AppError('Failed to send push notification', 500, 'PUSH_SEND_ERROR', {
                originalError: error.message,
            });
        }
    }
