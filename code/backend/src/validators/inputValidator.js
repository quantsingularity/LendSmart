...
class InputValidator {
    ...
    validateRegistration(data) {
        const schema = Joi.object({
            ...
            phoneNumber: Joi.string().pattern(this.patterns.phone).required().messages({
    ...
    validateLoanApplication(data) {
        const schema = Joi.object({
            ...
            termUnit: Joi.string().valid('days', 'weeks', 'months', 'years').required().messages({
    ...
    validatePayment(data) {
        const schema = Joi.object({
            ...
            walletAddress: Joi.when('paymentMethod', {
                is: 'crypto',
                then: Joi.string().pattern(this.patterns.walletAddress).required().messages({
    ...
    validateProfileUpdate(data) {
        const schema = Joi.object({
            ...
            walletAddress: Joi.string().pattern(this.patterns.walletAddress).optional().messages({
                'string.pattern.base': 'Please provide a valid Ethereum wallet address',
            }),
        });
