...
if (
    ...
    try {
        ...
        console.warn('⚠️  Redis client initialization failed, using memory fallback');
        redisClient = memoryClient;
    }
} else {
    console.warn('⚠️  Redis not configured or DB connection skipped, using memory fallback');
    redisClient = memoryClient;
}
