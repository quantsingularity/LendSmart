...
describe('Security Tests', () => {
  ...
  describe('Authentication Security', () => {
    describe('JWT Security', () => {
      ...
      it('should reject expired JWT tokens', async () => {
        ...
        const expiredToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxNGY5ZjI4ZjI4ZjI4ZjI4ZjI4ZjI4ZiIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNjMyNzY4MzY4LCJleHAiOjE2MzI3Njg0Mjh9.expired';
  ...
  describe('Data Protection', () => {
    describe('Sensitive Data Exposure', () => {
      it('should not expose sensitive user data in API responses', async () => {
        ...
        expect(response.body.data.user).to.not.have.property('passwordResetToken');
        expect(response.body.data.user).to.not.have.property('socialSecurityNumber');
      });
  ...
  describe('API Security', () => {
    it('should validate request content types', async () => {
      ...
      expect(response.body).to.have.property('error');
      expect(response.body.error).to.have.property('code', 'UNSUPPORTED_MEDIA_TYPE');
    });
