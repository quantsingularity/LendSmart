...
class AlternativeDataSource(ABC):
    ...
    def get_cached_data(
        self, borrower_id: str, max_age_days: int = 30
    ...
    def fetch_data(self, borrower_id: str, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            data = {
                ...
                "device_price_category": np.random.choice(
                    ["budget", "mid-range", "premium"]
                ),
                "typical_online_hours": np.random.choice(
    ...
    def fetch_data(self, borrower_id: str, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            data = {
                ...
                "discretionary_spending_ratio": expense_categories["entertainment"]
                + expense_categories["other"],
                "essential_spending_ratio": expense_categories["housing"]
    ...
    def fetch_data(self, borrower_id: str, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            data = {
                ...
                "utility_payment_trend": np.random.choice(
...
class AlternativeDataManager:
    ...
    def _init_default_sources(self) -> None:
        ...
        self.register_data_source(
            "digital_footprint",
            DigitalFootprintDataSource(self.config.get("digital_footprint", {})),
        )
        self.register_data_source(
            "transaction", TransactionDataSource(self.config.get("transaction", {}))
        )
        self.register_data_source(
            "utility_payment",
            UtilityPaymentDataSource(self.config.get("utility_payment", {})),
        )
        self.register_data_source(
            "education_employment",
            EducationEmploymentDataSource(self.config.get("education_employment", {})),
        )
    ...
    def collect_specific_data(
        self, borrower_id: str, sources: List[str], **kwargs
    ) -> pd.DataFrame:
        """
