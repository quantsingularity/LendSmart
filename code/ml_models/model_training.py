...
def create_synthetic_data(n_borrowers: Any = 1000, n_transactions: Any = 5000) -> Any:
    """
...
def feature_engineering(borrowers_df: Any, transactions_df: Any) -> Any:
    """
...
def preprocess_data(data_df: Any) -> Any:
    """
...
def train_and_evaluate_model(
    X_train: Any, y_train: Any, X_test: Any, y_test: Any
) -> Any:
    """
...
def save_evaluation_report(metrics_dict: Any) -> Any:
    """
