...
const RiskAssessment = () => {
  ...
  const handleSubmitRiskScore = async () => {
    ...
    try {
      ...
      setSuccess(
        `Risk score set successfully for loan ${selectedLoan.blockchainId}`,
      );
      ...
      <Paper elevation={3} sx={{ p: 3, mt: 3 }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" fontWeight="medium">
              {selectedLoan.isCollateralized
                ? `${selectedLoan.collateralAmount} Tokens`
                : "None"}
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            >
              <Button variant="outlined" onClick={() => setSelectedLoan(null)}>
                Cancel
              </Button>
              <Button
                variant="contained"
