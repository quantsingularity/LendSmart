        ...
        <div className="loan-card">
            ...
            <div className="loan-actions">
                ...
                {loan.status === 'marketplace' && currentUser && currentUser.role === 'lender' && (
                    <button className="button button-primary" onClick={() => onFundClick(loan)}>
                        Fund Loan
                    </button>
                )}
            </div>
        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <div className="loan-summary">
                    ...
                    <p>
                        <strong>Amount Requested:</strong> ${loan.amountRequested.toLocaleString()}
                    </p>
                    <p>
        ...
        <div className="filter-panel">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="filter-group">
                    ...
                    <select id="term" name="term" value={filters.term} onChange={handleChange}>
                ...
                <div className="loans-container">
                    {loading ? (
                        ...
                        <div className="error-message">
                            <p>{error}</p>
                            <button className="button button-primary" onClick={() => fetchLoans()}>
                                Try Again
                            </button>
                        </div>
