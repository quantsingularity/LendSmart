        ...
        try {
            ...
            const loanData = {
                ...
                collateralAmount:
                    formData.isCollateralized === 'true'
                        ...
                        : undefined,
                collateralToken:
                    formData.isCollateralized === 'true' ? formData.collateralToken : undefined,
            ...
            if (isConnected) {
                const blockchainData = {
                    ...
                    isCollateralized: formData.isCollateralized === 'true',
                    collateralToken:
                        formData.collateralToken || '0x0000000000000000000000000000000000000000',
                    collateralAmount:
                        formData.isCollateralized === 'true'
                            ? parseFloat(formData.collateralAmount)
                            : 0,
            ...
            setError(
                err.response?.data?.message || err.message || 'Failed to submit loan application',
            );
        }
    };
