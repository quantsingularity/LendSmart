...
export const updateUserProfile = (profileData) => apiService.put("/auth/profile", profileData);

// --- Loan Service Calls ---
export const applyLoan = (loanData) => apiService.post("/loans/apply", loanData);
export const getMarketplaceLoans = (params) => apiService.get("/loans", { params }); // e.g., params = { status: 'pending', page: 1, limit: 10 }
export const getMyLoans = (params) => apiService.get("/loans/my-loans", { params }); // e.g., params = { type: 'borrowed' }
export const getLoanDetails = (loanId) => apiService.get(`/loans/${loanId}`);
export const fundLoan = (loanId, fundingData) => apiService.post(`/loans/${loanId}/fund`, fundingData); // fundingData = { amountToFund: 100 }
export const recordRepayment = (loanId, repaymentData) => apiService.post(`/loans/${loanId}/repay`, repaymentData);
