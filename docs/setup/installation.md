...
- **Backend Logs**: Available in `code/backend/logs/`
- **Frontend Logs**: Available in browser console and error tracking service
- **Blockchain Logs**: Available in Ethereum client logs
...
- **GitHub Issues**: [https://github.com/abrar2030/LendSmart/issues](https://github.com/abrar2030/LendSmart/issues)
- **Documentation**: [https://docs.lendsmart.io](https://docs.lendsmart.io)
- **Community Forum**: [https://community.lendsmart.io](https://community.lendsmart.io)
- **Email Support**: support@lendsmart.io
